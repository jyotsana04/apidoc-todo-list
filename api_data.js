define({ "api": [
  {
    ...
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/Undo/addUndo",
    "title": "api to Add Undo.",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "key",
            "description": "<p>Action of the Undo. (body params) (required)</p>"
          }
        ]
      }
    },
    ...
    "filename": "app/routes/undo.js",
    "groupTitle": "Undo",
    "name": "PostApiV1UndoAddundo"
  },
  {
    "group": "Undo",
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/Undo/deleteUndo",
    "title": "api to Delete Undo(Latest Object will be deleted).",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Parameter": [
          {
            ...
            "description": "<p>resetPasswordToken of the user recieved on Email. (body params) (required)</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
